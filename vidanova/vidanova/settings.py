...
SECRET_KEY = 'django-insecure-c^6vfaa+t6#swdl39polz%3ohfl_g=m=j=9x=h4g$t^c7u&hi1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'followups.context_processors.alertas_globales',
            ],
        },
    },
]

WSGI_APPLICATION = 'vidanova.wsgi.application'
