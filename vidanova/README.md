...
El servidor (PC Principal) debe tener una IP Fija (ej: 192.168.1.189) configurada en Windows para que los enlaces no se rompan al reiniciar el router. para ver ip (En el powersheel escribe ipconfig)la ip esta en Dirección IPv4
